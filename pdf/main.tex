...
\begin{figure}[htb]
\centering
    \includegraphics[width=.85\textwidth]{figures/ml.jpg}
...
\begin{figure}[htb]
\centering
    \includegraphics[width=.85\textwidth]{figures/eocr-ex.jpg}
...
Para probar el sistema propuesto se han escogido dos conjuntos de datos: el primero\footnote{El conjunto de datos es descargable de la página: \url{https://www.kaggle.com/datasets/andrewmvd/car-plate-detection}} consta de 443 imágenes de vehículos con diferentes condiciones de visibilidad y ángulos con la matrícula visible. El segundo contiene un subconjunto recortado de 1980 imágenes de caracteres y letras\cite{visapp09} (3410 en total) resultando en 55 imágenes por caracter con 45/10 para los conjuntos de entrenamiento y validación. Las pruebas indican un 95.75\% de precisión en el conjunto de caracteres.
...
\begin{figure}[htb]
\centering
    \includegraphics[width=.85\textwidth]{figures/lic-ex.png}
...
\begin{table}[htb]
    ...
    \begin{tabular}{|c|c|c|c|c|c|c|}
         \hline   
         \textbf{Modelo} & \textbf{Entrenamiento (horas)} & \textbf{Accuracy} & \textbf{Precision} & \textbf{Recall} & \textbf{F1-score} & \textbf{Inference time}\\
         \hline
         \textbf{YOLOv5} & 15 h & 96.97\% & 97.90\% & 97.10\% & 97.5\% & 1.4 ms\\ 
         \hline
         \textbf{YOLOv8} & 17 h & 97.79\% & 98.20\% & 97.30\% & 97.7\% & 1.4 ms\\ 
         \hline
         \textbf{YOLOv9} & 20 h & 98.96\% & 99.8\% & 97.80\% & 98.8\% & 1.4 ms\\ 
         \hline
         \textbf{YOLOv10} & 25 h & 99.16\% & 99.8\% & 98.60\% & 99.2\% & 1 ms\\ 
         \hline
         \textbf{Faster R-CNN} & 45 h & 92\% & 92.50\% & 92\% & 92.2\% & 0.57\\ 
         \hline
         \textbf{SSD} & 28 h & 90\% & 91\% & 90.5\% & 90.7\% & 2.5 ms\\ 
         \hline
    \end{tabular}
...
\begin{figure}[htb]
\centering
    \includegraphics[width=.85\textwidth]{figures/tocr-ex.png}
...
\begin{figure}[htb]
\centering
    \includegraphics[width=.85\textwidth]{figures/sys-easyocr.png}
...
\begin{figure}[htb]
\centering
    \includegraphics[width=.85\textwidth]{figures/yolo8.png}
