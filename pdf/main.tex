...
\begin{longtable}{|p{16cm}|}
    \textbf{RESUMEN}:\\
    El objetivo de este proyecto ha sido realizar un programa que pueda realizar múltiples funciones útiles para ayudar a la gestión del tráfico urbano, comenzando con la base de la detección y reconocimiento de vehículos y la detección y lectura de sus matrículas. Esta tarea es realizada a partir de archivos (vídeos e imágenes) y múltiples cámaras, que el programa lee, reconoce y procesa para tener los resultados de la detección \\
    \hline
\end{longtable}
...
Para empezar, la citación de los cinco datasets utilizados; \cite{Sanchez-Iborra2026}, \cite{bdd100k}, \cite{RAMAJOBALLESTER2024104608} (datasets UC3M) y \cite{xu2018towards}. Todos estos conjuntos de datos han sido creados para fines experimentales y de investigación en relación con el propósito de este proyecto. 
