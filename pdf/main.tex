...
Ya que el modelo YOLO necesita un estructurado concreto, lo primero es construir un programa personalizado que modifique la estructura de los conjuntos de datos utilizados para entrenar y validar los modelos

para que sigan el \textbf{formato <class\_id> <center\_x> <center\_y> <width> <height>}, correspondiendo al número identificador de la clase, las coordenadas x e y del centro de la \textit{bounding box} y el ancho y altura de esta última. Estos cuatro últimos valores están normalizados al rango [0,1].
